 ...
 */
export declare type ThemeColorsName = 'primary' | 'secondary' | 'black' | 'white' | 'gray' | 'red' | 'transparent' | 'yellow';
/**
 ...
 * ```
 */
export declare type ThemeColorsGroup = {
 ...
 */
export declare type ThemeColors = typeof colors;
/**
 ...
 * ```
 */
export declare type ThemeFontSizes = {
 ...
 */
export declare type ThemeUnits = {
 ...
 * ```
 */
export declare type ThemePaddings = {
 ...
 */
export declare type ThemedProps<P> = ThemedStyledProps<P, Theme>;
